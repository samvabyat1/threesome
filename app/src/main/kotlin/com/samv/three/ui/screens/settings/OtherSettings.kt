...
import com.samv.three.service.PlayerMediaBrowserService
import com.samv.three.ui.components.themed.Header
import com.samv.three.ui.styling.LocalAppearance
import com.samv.three.utils.isAtLeastAndroid12
import com.samv.three.utils.isAtLeastAndroid6
import com.samv.three.utils.isIgnoringBatteryOptimizations
...
fun OtherSettings() {
    ...
    val queriesCount by remember {
        com.samv.three.Database.queriesCount().distinctUntilChanged()
    ...
    Column(
        ...
        SettingsEntry(
            ...
            onClick = { com.samv.three.query(com.samv.three.Database::clearQueries) }
        )
