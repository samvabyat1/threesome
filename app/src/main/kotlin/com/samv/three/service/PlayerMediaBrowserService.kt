        ...
        runBlocking(Dispatchers.IO) {
            result.sendResult(
                when (parentId) {
                    ...
                    MediaId.songs -> com.samv.three.Database
                        .songsByPlayTimeDesc()
                        .first()
                        .take(30)
                        .also { lastSongs = it }
                    ...
                    MediaId.playlists -> com.samv.three.Database
                    ...
                    MediaId.albums -> com.samv.three.Database
                        .albumsByRowIdDesc()
                        .first()
                        .map { it.asBrowserMediaItem }
                        .toMutableList()
        ...
        override fun onPlayFromMediaId(mediaId: String?, extras: Bundle?) {
            ...
            coroutineScope.launch {
                val mediaItems = when (data.getOrNull(0)) {
                    ...
                    MediaId.favorites -> com.samv.three.Database
                        .favorites()
                        .first()
                        .shuffled()

                    MediaId.offline -> com.samv.three.Database
                    ...
                    MediaId.playlists -> data
                        .getOrNull(1)
                        ?.toLongOrNull()
                        ?.let(com.samv.three.Database::playlistWithSongs)
                        ?.first()
                        ?.songs
                        ?.shuffled()
                    ...
                    MediaId.albums -> data
                        .getOrNull(1)
                        ?.let(com.samv.three.Database::albumSongs)
                        ?.first()
