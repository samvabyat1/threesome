package com.samv.three.service
...
import com.samv.innertube.models.bodies.PlayerBody
import com.samv.innertube.requests.player
import com.samv.three.MainActivity
import com.samv.three.R
import com.samv.three.enums.ExoPlayerDiskCacheMaxSize
import com.samv.three.models.Event
import com.samv.three.models.QueuedMediaItem
import com.samv.three.utils.InvincibleService
import com.samv.three.utils.RingBuffer
import com.samv.three.utils.TimerJob
import com.samv.three.utils.YouTubeRadio
import com.samv.three.utils.activityPendingIntent
import com.samv.three.utils.broadCastPendingIntent
import com.samv.three.utils.exoPlayerDiskCacheMaxSizeKey
import com.samv.three.utils.findNextMediaItemById
import com.samv.three.utils.forcePlayFromBeginning
import com.samv.three.utils.forceSeekToNext
import com.samv.three.utils.forceSeekToPrevious
import com.samv.three.utils.getEnum
import com.samv.three.utils.intent
import com.samv.three.utils.isAtLeastAndroid13
import com.samv.three.utils.isAtLeastAndroid6
import com.samv.three.utils.isAtLeastAndroid8
import com.samv.three.utils.isInvincibilityEnabledKey
import com.samv.three.utils.isShowingThumbnailInLockscreenKey
import com.samv.three.utils.mediaItems
import com.samv.three.utils.persistentQueueKey
import com.samv.three.utils.preferences
import com.samv.three.utils.queueLoopEnabledKey
import com.samv.three.utils.resumePlaybackWhenDeviceConnectedKey
import com.samv.three.utils.shouldBePlaying
import com.samv.three.utils.skipSilenceKey
import com.samv.three.utils.timer
import com.samv.three.utils.trackLoopEnabledKey
import com.samv.three.utils.volumeNormalizationKey
...
class PlayerService : InvincibleService(), Player.Listener, PlaybackStatsListener.Callback,
    ...
    override fun onPlaybackStatsReady(
        ...
        if (totalPlayTimeMs > 5000) {
            com.samv.three.query {
                com.samv.three.Database.incrementTotalPlayTimeMs(
                    mediaItem.mediaId,
                    totalPlayTimeMs
                )
            }
        ...
        if (totalPlayTimeMs > 30000) {
            com.samv.three.query {
                try {
                    com.samv.three.Database.insert(
                        Event(
    ...
    private fun maybeSavePlayerQueue() {
        ...
        mediaItems.mapIndexed { index, mediaItem ->
            ...
            com.samv.three.query {
                com.samv.three.Database.clearQueue()
                com.samv.three.Database.insert(queuedMediaItems)
            }
        }
    }
    ...
    private fun maybeRestorePlayerQueue() {
        ...
        com.samv.three.query {
            val queuedSong = com.samv.three.Database.queue()
            com.samv.three.Database.clearQueue()
    ...
    private fun maybeNormalizeVolume() {
        ...
        player.currentMediaItem?.mediaId?.let { songId ->
            ...
            volumeNormalizationJob = coroutineScope.launch(Dispatchers.Main) {
                com.samv.three.Database.loudnessDb(songId).cancellable().collectLatest { loudnessDb ->
                    try {
                                    ...
                                    if (mediaItem?.mediaMetadata?.extras?.getString("durationText") == null) {
                                        format.approxDurationMs?.div(1000)
                                            ...
                                            ?.let { durationText ->
                                                ...
                                                com.samv.three.Database.updateDurationText(videoId, durationText)
                                            }
                                    }

                                    com.samv.three.query {
                                        mediaItem?.let(com.samv.three.Database::insert)

                                        com.samv.three.Database.insert(
                                            com.samv.three.models.Format(
                                                songId = videoId,
                                                itag = format.itag,
    ...
    private value class Action(val value: String) {
        ...
        companion object {
            val pause = Action("com.samv.three.pause")
            val play = Action("com.samv.three.play")
            val next = Action("com.samv.three.next")
            val previous = Action("com.samv.three.previous")
        }
    }
