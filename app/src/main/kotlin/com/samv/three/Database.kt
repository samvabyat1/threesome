...
import com.samv.three.enums.ArtistSortBy
...
import com.samv.three.models.Format
import com.samv.three.models.Info
import com.samv.three.models.Lyrics
...
import com.samv.three.models.SongArtistMap
import com.samv.three.models.SongPlaylistMap
import com.samv.three.models.SortedSongPlaylistMap
import kotlin.jvm.Throws
import kotlinx.coroutines.flow.Flow

@Dao
interface Database {
    companion object : com.samv.three.Database by com.samv.three.DatabaseInitializer.Companion.Instance.database
...
@androidx.room.Database(
    ...
    autoMigrations = [
        ...
        AutoMigration(from = 3, to = 4, spec = com.samv.three.DatabaseInitializer.From3To4Migration::class),
        AutoMigration(from = 4, to = 5),
        AutoMigration(from = 5, to = 6),
        AutoMigration(from = 6, to = 7),
        AutoMigration(from = 7, to = 8, spec = com.samv.three.DatabaseInitializer.From7To8Migration::class),
        AutoMigration(from = 9, to = 10),
        AutoMigration(from = 11, to = 12, spec = com.samv.three.DatabaseInitializer.From11To12Migration::class),
        ...
        AutoMigration(from = 20, to = 21, spec = com.samv.three.DatabaseInitializer.From20To21Migration::class),
        AutoMigration(from = 21, to = 22, spec = com.samv.three.DatabaseInitializer.From21To22Migration::class),
    ],
)
@TypeConverters(com.samv.three.Converters::class)
abstract class DatabaseInitializer protected constructor() : RoomDatabase() {
    abstract val database: com.samv.three.Database

    companion object {
        lateinit var Instance: com.samv.three.DatabaseInitializer

        context(Context)
        operator fun invoke() {
            if (!com.samv.three.DatabaseInitializer.Companion::Instance.isInitialized) {
                com.samv.three.DatabaseInitializer.Companion.Instance = Room
                    .databaseBuilder(this@Context, com.samv.three.DatabaseInitializer::class.java, "data.db")
                    .addMigrations(
                        com.samv.three.DatabaseInitializer.From8To9Migration(),
                        com.samv.three.DatabaseInitializer.From10To11Migration(),
                        com.samv.three.DatabaseInitializer.From14To15Migration(),
                        com.samv.three.DatabaseInitializer.From22To23Migration()
                    )
                    .build()
            }
        }
...
val com.samv.three.Database.internal: RoomDatabase
    get() = com.samv.three.DatabaseInitializer.Companion.Instance

fun query(block: () -> Unit) = com.samv.three.DatabaseInitializer.Companion.Instance.queryExecutor.execute(block)

fun transaction(block: () -> Unit) = with(com.samv.three.DatabaseInitializer.Companion.Instance) {
